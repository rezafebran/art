...
<script type="text/javascript" src="js/jquery-1.10.2.min.js"></script>
   <script src="https://maps.googleapis.com/maps/api/js?AIzaSyCDugynNgqEUpvX0zbZ_780z5O3tJgTX_s&callback=initMap"
    async defer></script>
<script type="text/javascript">
$(document).ready(function() {

	var mapCenter = new google.maps.LatLng(-6.1674356, 106.7637634); //Google map Coordinates
	var map;
	...
	function map_initialize()
	{
			...
			google.maps.event.addListener(map, 'rightclick', function(event) {
				...
				'<label for="pType"><span>Type :</span> <select name="pType" class="save-type"><option value="toko ">toko cabang ke 1</option><option value="toko cabang ke 2">toko cabang ke 2</option>'+
				'<option value="toko cabang ke 3">toko cabang ke 3</option></select></label>'+
				'</form>'+
...
<body>             
<h1 class="heading">ART SHOE STORE</h1>
